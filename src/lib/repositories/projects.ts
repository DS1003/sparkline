...
export const projectsData: Project[] = [
  {
    ...
    description: 'NDAKARU avait besoin d’une infrastructure numérique évolutive capable d’absorber d’importants pics saisonniers tout en offrant des temps de chargement instantanés et des passerelles de paiement locales (Wave, Orange Money).',
    challenge: 'Les plateformes existantes généraient des taux d’abandon élevés sur les réseaux mobiles 3G/4G, avec des parcours d’achat complexes dépourvus de paiements mobiles locaux.',
    ...
    technologies: ['Next.js 15', 'TypeScript', 'Tailwind CSS', 'GraphQL', 'Stripe & Wave API', 'PostgreSQL'],
    coverImage: '/images/projects/ndakaru.jpg',
    galleryImages: [
      '/images/projects/ndakaru.jpg',
      '/images/services/development.jpg',
      '/images/services/ui-ux.jpg',
      '/images/approach/step-3.jpg',
    ],
    testimonial: {
  ...
  },
  {
    ...
    year: '2024',
    summary: 'Un tableau de bord décisionnel intelligent fournissant des métriques financières et télémétriques en temps réel pour les entreprises africaines en forte croissance.',
    ...
    technologies: ['React 19', 'Next.js 15', 'Tailwind CSS', 'Recharts', 'WebSockets', 'PostgreSQL', 'TypeScript'],
    coverImage: '/images/services/development.jpg',
    galleryImages: [
      '/images/services/development.jpg',
      '/images/services/ui-ux.jpg',
      '/images/approach/step-1.jpg',
      '/images/projects/ndakaru.jpg',
    ],
    testimonial: {
  ...
  },
  {
    ...
    technologies: ['Figma', 'Next.js 15', 'Tailwind CSS', 'Three.js / WebGL', 'Framer Motion', 'TypeScript'],
    coverImage: '/images/services/branding.jpg',
    galleryImages: [
      '/images/services/branding.jpg',
      '/images/services/mobile.jpg',
      '/images/approach/step-2.jpg',
      '/images/services/ui-ux.jpg',
    ],
  },
  {
    ...
    technologies: ['Next.js 15', 'React Native', 'WebRTC', 'Tailwind CSS', 'Node.js', 'TypeScript'],
    coverImage: '/images/services/mobile.jpg',
    galleryImages: [
      '/images/services/mobile.jpg',
      '/images/services/ui-ux.jpg',
      '/images/approach/step-4.jpg',
      '/images/projects/ndakaru.jpg',
    ],
  },
  {
    ...
    technologies: ['Next.js 15', 'TypeScript', 'Tailwind CSS', 'Zustand', 'Socket.io', 'PostgreSQL'],
