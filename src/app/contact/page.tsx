...
export default function ContactPage() {
  ...
  const isOnlySparklearn =
    formData.services.length === 1 && formData.services[0] === 'Sparklearn Formation'
      ...
      <Section className="py-10 sm:py-20 lg:py-28 bg-[#F7F8FA]">
        <Container>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-stretch mb-10 sm:mb-16">
            ...
            <div className="lg:col-span-7 bg-white rounded-[28px] sm:rounded-[40px] p-5 sm:p-9 lg:p-10 border border-neutral-200/80 shadow-[inset_0_1px_1px_rgba(255,255,255,1),inset_0_-2px_4px_rgba(0,0,0,0.03),0_16px_40px_-15px_rgba(0,0,0,0.06)] flex flex-col justify-between relative overflow-hidden min-h-[580px]">
                  ...
                  >
                        ...
                        {budgetOptions.map((budget) => {
                          ...
                          return (
                            <button
                              ...
                              className={`py-2 sm:py-2.5 px-2.5 sm:px-3 rounded-full text-xs font-mono font-medium transition-all duration-200 text-center cursor-pointer disabled:cursor-not-allowed ${
                                isSelected
                    ...
                    <div className="pt-1 sm:pt-2">
                      <button
                        type="submit"
                        disabled={loading}
                        className="relative overflow-hidden w-full py-3 sm:py-3.5 px-6 sm:px-7 rounded-full bg-[#EB4604] hover:bg-[#D43D00] text-white font-semibold text-xs sm:text-sm shadow-[inset_0_1.5px_1px_rgba(255,255,255,0.4),inset_0_-2.5px_3px_rgba(0,0,0,0.25),0_8px_24px_rgba(235,70,4,0.3)] hover:shadow-[0_10px_28px_rgba(235,70,4,0.4)] active:translate-y-[1px] transition-all flex items-center justify-between group cursor-pointer disabled:opacity-90 disabled:cursor-not-allowed"
                      >
