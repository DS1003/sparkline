        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6 items-stretch">
          ...
          <div className="lg:col-span-4 flex">
            <RevealOnScroll delay={0.25} className="w-full">
              <div className="w-full h-full sm:min-h-[420px] rounded-[24px] sm:rounded-[32px] bg-white border border-[#E5E7EB] p-5 sm:p-9 shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-[0_12px_35px_rgba(0,0,0,0.06)] hover:border-neutral-300 transition-all duration-500 flex flex-col justify-between group">
                {/* Header */}
          ...
          {/* ═══════════════════════════════════════════════════════════
              ...
              ═══════════════════════════════════════════════════════════ */}
          {/* On mobile: 2-col side-by-side stat cards. On sm+: stacked column. */}
          <div className="lg:col-span-4 grid grid-cols-2 sm:flex sm:flex-col gap-3 sm:gap-6">
            {/* Fondation EST. 2024 */}
            <RevealOnScroll delay={0.3} className="flex">
              <div className="w-full rounded-[20px] sm:rounded-[28px] bg-[#0A0A0A] text-white p-4 sm:p-8 border border-neutral-800 shadow-md flex flex-col justify-between hover:border-neutral-700 transition-all duration-300">
                <div className="space-y-1.5 sm:space-y-2">
                  <div className="flex items-center justify-between gap-1">
                    <span className="text-[9px] sm:text-[10px] font-mono uppercase tracking-widest text-[#EB4604] font-bold">
                      Fondation
                    </span>
                    <span className="hidden sm:inline px-2.5 py-0.5 rounded-full bg-white/10 text-[10px] font-mono text-neutral-300">
                      Collectif Tech &amp; Design
                    </span>
                  </div>
                  <div className="text-xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-white font-mono">
                    EST. 2024
                  </div>
                  <p className="hidden sm:block text-neutral-300 text-xs sm:text-sm font-light leading-relaxed">
                    Un collectif d&apos;ingénieurs et de designers unis pour concevoir des moteurs numériques durables.
                  </p>
                  <p className="sm:hidden text-neutral-400 text-[10px] font-light leading-snug">
                    Collectif Tech &amp; Design
                  </p>
                </div>
              </div>
            ...
            {/* Ancrage Dakar */}
            <RevealOnScroll delay={0.35} className="flex">
              <div className="w-full rounded-[20px] sm:rounded-[28px] bg-white p-4 sm:p-8 border border-[#E5E7EB] shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-[0_12px_35px_rgba(0,0,0,0.06)] hover:border-neutral-300 transition-all duration-300 flex flex-col justify-between">
                <div className="space-y-1.5 sm:space-y-2">
                  <div className="flex items-center justify-between gap-1">
                    <span className="text-[9px] sm:text-[10px] font-mono uppercase tracking-widest text-neutral-400 font-bold">
                      Ancrage
                    </span>
                    <span className="hidden sm:inline px-2.5 py-0.5 rounded-full bg-neutral-100 text-[10px] font-mono text-neutral-600">
                      International
                    </span>
                  </div>
                  <div className="text-lg sm:text-3xl lg:text-4xl font-bold tracking-tight text-[#0A0A0A] font-mono">
                    Dakar, Sénégal
                  </div>
                  <p className="hidden sm:block text-neutral-600 text-xs sm:text-sm font-light leading-relaxed">
                    Fondé à Dakar avec un rayonnement global pour propulser les leaders africains et internationaux.
                  </p>
                  <p className="sm:hidden text-neutral-500 text-[10px] font-light leading-snug">
                    Rayonnement global
                  </p>
                </div>
              </div>
          ...
          <div className="lg:col-span-4 flex">
            <RevealOnScroll delay={0.4} className="w-full">
              <div className="w-full h-full sm:min-h-[420px] rounded-[28px] sm:rounded-[32px] bg-white border border-[#E5E7EB] p-5 sm:p-9 shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-[0_12px_35px_rgba(0,0,0,0.06)] hover:border-neutral-300 transition-all duration-500 flex flex-col justify-between group">
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <blockquote className="text-sm sm:text-[17px] text-[#0A0A0A] font-medium leading-relaxed">
                ...
                <div className="pt-4 sm:pt-6 border-t border-neutral-100 space-y-3 mt-4 sm:mt-0">
                  <div className="flex items-center gap-3">
                    <div className="flex -space-x-2 shrink-0">
                      <div className="relative w-7 h-7 sm:w-8 sm:h-8 rounded-full overflow-hidden border-2 border-white shadow-xs">
                        <Image src="/images/brand/Ndiaga.png" alt="Ndiaga Lo" fill sizes="32px" className="object-cover" />
                      </div>
                      <div className="relative w-7 h-7 sm:w-8 sm:h-8 rounded-full overflow-hidden border-2 border-white shadow-xs">
                        <Image src="/images/brand/Fanta.png" alt="Fanta Ndao Tine" fill sizes="32px" className="object-cover" />
                      </div>
                      <div className="relative w-7 h-7 sm:w-8 sm:h-8 rounded-full overflow-hidden border-2 border-white shadow-xs">
                        <Image src="/images/brand/Seydina.png" alt="Seydina Mohamed Diop" fill sizes="32px" className="object-cover" />
                      </div>
                    </div>

                    <div className="space-y-0.5 min-w-0">
                      <p className="text-xs font-semibold text-neutral-900 truncate">Le Collectif SPARKLINE</p>
                      <p className="text-[10px] font-mono text-neutral-500 truncate">Ingénieurs, Designers &amp; Stratèges</p>
                    </div>
                  </div>
                </div>
              </div>
