...
interface SparkLearnShowcaseProps {
  overview: {
...
export function SparkLearnShowcase({ overview, masterclasses }: SparkLearnShowcaseProps) {
  ...
  return (
    <div className="bg-[#FAFBFD] border-b border-[#E5E7EB]">
      {/* ── 1. Impact Counters Strip ── */}
      <section className="py-10 sm:py-12 bg-white border-b border-[#E5E7EB]">
        <Container>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            <Counter
              value={overview.masterclassesCount}
              suffix="+"
              label="Masterclasses gratuites"
              description="Dans les universités et hubs tech"
            />
            <Counter
              value={overview.studentsTrained}
              suffix="+"
              label="Apprenants formés"
              description="Futurs ingénieurs et designers"
            />
            <Counter
              value={overview.activeBootcamps}
              suffix=""
              label="Bootcamps actifs"
              description="Programmes intensifs & pratiques"
            />
            <Counter
              value={overview.partnerInstitutions}
              suffix="+"
              label="Partenaires académiques"
              description="Universités & incubateurs"
            />
          </div>
        </Container>
      </section>

      {/* ── 2. Top Bento 3-Column Layout (Épuré, Moderne & Sans Boutons de Redirection) ── */}
        ...
        <Container>
          <div className="rounded-[24px] sm:rounded-[28px] bg-white border border-[#E5E7EB] p-6 sm:p-8 lg:p-9 shadow-[0_4px_25px_rgba(0,0,0,0.02)] mb-12 sm:mb-16">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-stretch">
              ...
              {/* ── Column 2: Center Spotlight Card (Sans Bouton, Enrichi & Moderne) ── */}
              ...
              {/* ── Column 3: Big Matte Black Hero Card (Sans Bouton, Épuré & Prestigieux) ── */}
          ...
          {/* ── 3. Masterclasses & Sessions Grid (Compact 4-Column Grid) ── */}
