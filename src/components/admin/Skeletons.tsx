...
export function SkeletonBlock({
  ...
  return (
    <div
      className={`relative overflow-hidden bg-neutral-200/70 dark:bg-neutral-800/60 ${rounded} ${className} before:absolute before:inset-0 before:-translate-x-full before:animate-[shimmer_1.8s_infinite] before:bg-gradient-to-r before:from-transparent before:via-white/40 before:to-transparent`}
    />
  )
}
  ...
  return (
    <div className="w-full animate-in fade-in duration-300">
      ...
      <div className="hidden md:block overflow-hidden">
        {/* Table Header */}
        <div className="px-6 py-4 bg-neutral-50/80 border-b border-neutral-200/70 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <SkeletonBlock className="w-4 h-4" rounded="rounded" />
            <SkeletonBlock className="w-32 h-3.5" rounded="rounded-md" />
          </div>
          <div className="flex items-center gap-8">
            <SkeletonBlock className="w-24 h-3.5" rounded="rounded-md" />
            <SkeletonBlock className="w-20 h-3.5" rounded="rounded-md" />
            <SkeletonBlock className="w-20 h-3.5" rounded="rounded-md" />
            <SkeletonBlock className="w-16 h-3.5" rounded="rounded-md" />
          </div>
        </div>
        ...
        <div className="divide-y divide-neutral-100">
          {Array.from({ length: rowsCount }).map((_, idx) => (
            <div
              key={idx}
              className="px-6 py-4 flex items-center justify-between bg-white hover:bg-neutral-50/40 transition-colors"
            >
              {/* Left: Avatar + Title/Email */}
              <div className="flex items-center gap-3.5 min-w-[280px]">
                ...
                <div className="space-y-1.5 flex-1">
                  <SkeletonBlock className="w-40 h-4" rounded="rounded-md" />
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div className="space-y-1">
                  <SkeletonBlock className="w-36 h-4" rounded="rounded-md" />
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 animate-in fade-in duration-300">
      {columns.map((col, cIdx) => (
        <div
          key={cIdx}
          className="bg-neutral-100/60 rounded-2xl p-3 border border-neutral-200/60 flex flex-col gap-3 min-h-[420px]"
        >
          {/* Column Header */}
          ...
          <div className="space-y-3 flex-1">
            {Array.from({ length: cIdx === 0 ? 3 : 2 }).map((_, rIdx) => (
              <div
                key={rIdx}
                className="bg-white rounded-xl p-3.5 border border-neutral-200/80 shadow-xs space-y-3"
              >
                <div className="flex items-start justify-between">
                  <div className="space-y-1.5 flex-1">
                    <SkeletonBlock className="w-32 h-4" rounded="rounded-md" />
                ...
                <div className="pt-2 border-t border-neutral-100 flex items-center justify-between">
                  <SkeletonBlock className="w-14 h-3.5" rounded="rounded-md" />
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      {Array.from({ length: 4 }).map((_, idx) => (
        ...
        >
          <div className="flex items-center justify-between">
            <SkeletonBlock className="w-28 h-3.5" rounded="rounded-md" />
            <SkeletonBlock className="w-10 h-10" rounded="rounded-xl" />
          </div>
          <div className="space-y-2">
            <SkeletonBlock className="w-20 h-8" rounded="rounded-lg" />
            <div className="flex items-center gap-2">
              <SkeletonBlock className="w-12 h-5" rounded="rounded-full" />
              <SkeletonBlock className="w-24 h-3" rounded="rounded-md" />
            </div>
          </div>
        </div>
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="bg-white rounded-2xl sm:rounded-[24px] p-5 sm:p-6 border border-neutral-200/80 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="space-y-2">
          <SkeletonBlock className="w-48 h-6" rounded="rounded-lg" />
          <SkeletonBlock className="w-72 h-4" rounded="rounded-md" />
        </div>
        <div className="flex items-center gap-2.5">
          <SkeletonBlock className="w-28 h-9" rounded="rounded-full" />
          <SkeletonBlock className="w-32 h-9" rounded="rounded-full" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-2xl sm:rounded-[24px] p-5 sm:p-6 border border-neutral-200/80 shadow-xs space-y-4">
          ...
          <div className="space-y-2">
            <SkeletonBlock className="w-full h-3" rounded="rounded-md" />
            <SkeletonBlock className="w-3/4 h-3" rounded="rounded-md" />
          </div>
        </div>
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl sm:rounded-[24px] p-5 sm:p-6 border border-neutral-200/80 shadow-xs space-y-4">
          <div className="flex items-center justify-between">
            <SkeletonBlock className="w-40 h-4" rounded="rounded-md" />
            <SkeletonBlock className="w-28 h-7" rounded="rounded-full" />
          </div>
            ...
            {Array.from({ length: 7 }).map((_, i) => (
              <div key={i} className="flex-1 flex flex-col items-center gap-2">
                <SkeletonBlock
                  ...
                  rounded="rounded-lg"
                />
                <SkeletonBlock className="w-6 h-3" rounded="rounded-sm" />
              </div>
            ))}
          </div>
        </div>
